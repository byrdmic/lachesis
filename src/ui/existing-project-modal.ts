...
import { getAllWorkflows, PROJECT_FILES } from '../core/workflows/definitions'
...
import { containsIdeasGroomResponse } from '../utils/ideas-groom-parser'
...
export class ExistingProjectModal extends Modal {
  ...
  private focusedFile: ExpectedCoreFile | null = null
  private lastUsedWorkflowName: WorkflowName | null = null
  ...
  private async handleDiffAction(diffBlock: DiffBlock, action: string): Promise<void> {
