// UI Components
// Re-exports for the extracted modal components

export { ChatSidebar, type ChatSidebarCallbacks } from './chat-sidebar'
export { IssuesPanel, type IssuesPanelCallbacks, type ProjectIssue } from './issues-panel'
